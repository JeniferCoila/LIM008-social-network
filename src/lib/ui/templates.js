...
export const viewTemplates = {
  ...
  home: () => {
    const tmpl = `<header class='header-page'><div>
                  ...
                  <nav class='menu-nav'>
                    <ul class='menu-ul'>
                      <li  class='li-menu2'><a class='items'><img class='img-logo  align top' src='img/historia.png' alt='icono'><h2 id= "all-stories" class='text-3'>Todas las historias</h2></a></li>
                      <li  class='li-menu2'><a class='items'><img class='img-logo  align top' src='img/historia.png' alt='icono'><h2 id= "priv-stories" class='text-3'>Historias Privadas</h2></a></li>
                      <li class='li-menu2'><a class='items items-2'><img class='img-logo  align top' src='img/calendario.png' alt='icono'><h2  id= "public-stories" class='text-6'>Historias Publicas</h2></a></li>
    ...
    const privPostBtn = section.querySelector('#priv-stories');
    ...
    const allPostBtn = section.querySelector('#all-stories');
    ...
    privPostBtn.addEventListener('click', () => {
      ...
      getPostByPrivacy('Privado');
    });

    publicPostBtn.addEventListener('click', () => {
      document.getElementById('menu-bar').checked = false;
      getPostByPrivacy('Público');
    });

    const getPostByPrivacy = (privacy) => {
      getPrivPosts(((posts) => {  
        postContainer.innerHTML = '';
        posts.forEach(post => {
          const uid = isUserSignedIn();
